...
function printRecipe() {
  ...
  w.document.write(`<!DOCTYPE html><html dir="rtl" lang="ar"><head><meta charset="utf-8"><title>وصفة عطر</title><style>body{font-family:Tahoma,Arial,sans-serif;padding:30px;color:#1a1a1a;line-height:2;font-size:15px}h1{color:#a8852a;font-size:22px;border-bottom:2px solid #e8c070;padding-bottom:8px}pre{white-space:pre-wrap;font-family:inherit}</style></head><body><h1>🧴 حاسبة العطور</h1><pre>${safe}</pre></body></html>`);
