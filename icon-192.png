...
const BRANDS = [
  ...
  {b:"Cartier", ar:"كارتيير", cat:"🌍", items:[
    ...
    {n:"Santos de Cartier EDT",       f:"aromatic", isoBranded:true, sandalPct:0.015, g:"m"},
    {n:"La Panthère EDP",             f:"floral",   isoBranded:true, sandalPct:0.015, g:"f"},
...
const EXTRA_PERFUMES = {
  ...
  "Cartier":[
    {n:"L'Envol de Cartier EDP",       f:"woody",    isoBranded:true, sandalPct:0.020, g:"m"},
    {n:"Roadster EDT",                  f:"aromatic", isoBranded:true, sandalPct:0.012, g:"m"},
    {n:"Déclaration d'Un Soir EDT",    f:"fresh",    isoBranded:true, sandalPct:0.015, g:"m"},
    {n:"Pasha de Cartier EDP",         f:"woody",    isoBranded:true, sandalPct:0.020, g:"m"},
    {n:"Les Heures Voyageuses Oud & Oud EDP", f:"oud", isoBranded:true, sandalPct:0.035, g:"u"},
    {n:"Oud & Rose EDP",               f:"oud",      isoBranded:true, sandalPct:0.030, g:"u"},
    {n:"La Panthère Légère EDP",       f:"floral",   isoBranded:true, sandalPct:0.010, g:"f"},
